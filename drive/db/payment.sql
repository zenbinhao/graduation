...
-- 缴费信息
-- ----------------------------
DROP TABLE IF EXISTS `drive_payment`;
CREATE TABLE `drive_payment`  (
             ...
             `is_check` tinyint(1) NOT NULL DEFAULT 0 COMMENT '收费认定（0未受理、1已确认、2驳回）',
...
ALTER TABLE drive_payment COMMENT '缴费信息';
