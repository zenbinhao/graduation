...
public class MapperAspect {
    ...
    @Pointcut("execution(* com.binhao.drive.common.mapper.MapperCustom.insert(..))")
    public void pointInsertService() {
    }

    @Pointcut("execution(* com.binhao.drive.common.mapper.MapperCustom.update(..))")
    public void pointUpdateService() {
    }

    @Pointcut("execution(* com.binhao.drive.common.mapper.MapperCustom.updateById(..))")
